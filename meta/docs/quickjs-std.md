...
Constant for [FILE.seek](/meta/docs/quickjs-std.md#file-seek-method). Declares that pointer offset should be relative to the beginning of the file. See also libc `fseek()`.
...
Constant for [FILE.seek](/meta/docs/quickjs-std.md#file-seek-method). Declares that the offset should be relative to the current position of the FILE handle. See also libc `fseek()`.
...
Constant for [FILE.seek](/meta/docs/quickjs-std.md#file-seek-method). Declares that the offset should be relative to the end of the file. See also libc `fseek()`.
...
Constant for [FILE.setvbuf](/meta/docs/quickjs-std.md#file-setvbuf-method). Declares that the buffer mode should be 'full buffering'.
...
Constant for [FILE.setvbuf](/meta/docs/quickjs-std.md#file-setvbuf-method). Declares that the buffer mode should be 'line buffering'.
...
Constant for [FILE.setvbuf](/meta/docs/quickjs-std.md#file-setvbuf-method). Declares that the buffer mode should be 'no buffering'.
...
The type of the object returned by [getpwuid](/meta/docs/quickjs-std.md#quickjs-std-getpwuid-exported-function).
