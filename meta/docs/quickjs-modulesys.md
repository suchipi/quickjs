...
[searchExtensions](/meta/docs/quickjs-modulesys.md#moduledelegate-searchextensions-property).
...
[ModuleDelegate.searchExtensions](/meta/docs/quickjs-modulesys.md#moduledelegate-searchextensions-property), and use one of those if present.
...
delegates directly to [ModuleDelegate.resolve](/meta/docs/quickjs-modulesys.md#moduledelegate-resolve-method) to resolve the name.
