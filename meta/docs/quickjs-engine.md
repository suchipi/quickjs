...
The main module can be set via [setMainModule](/meta/docs/quickjs-engine.md#quickjs-engine-setmainmodule-exported-function).
...
This is a parallel formatter to [inspect](/meta/docs/quickjs-inspect.md#inspect-inspectfunction) — it uses the engine's
