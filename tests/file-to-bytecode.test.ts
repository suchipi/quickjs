...
test("file-to-bytecode.js works", async () => {
  ...
  expect(bytecodeView).toMatchInlineSnapshot(`
    "Buffer [
    	...
    	│0x00000160│ 03 01 0D D2 03 00 01 08 EA 05 C0 00 E3 29 DF EE
    	...
    	│0x000001C0│ 00 61 02 00 61 01 00 61 00 00 06 11 F2 EB 1A 7E
    	│0x000001D0│ 81 00 0E C9 81 00 0E CA 81 00 0E CB 81 00 0E CC
    	│0x000001E0│ 81 00 0E C3 04 84 EC 09 0E 38 F1 00 00 00 EC E0
    	│0x000001F0│ 62 02 00 11 EA 05 0E 62 03 00 96 EA 10 38 99 00
    	│0x00000200│ 00 00 11 04 F2 00 00 00 21 01 00 2F 62 04 00 96
    	│0x00000210│ EA 09 62 02 00 11 63 04 00 0E 65 00 00 42 F3 00
    	│0x00000220│ 00 00 62 02 00 0B 62 04 00 4C EE 00 00 00 24 02
    	│0x00000230│ 00 C3 05 65 01 00 42 F4 00 00 00 62 03 00 04 F5
    	│0x00000240│ 00 00 00 24 02 00 C3 06 62 06 00 42 F6 00 00 00
    	│0x00000250│ 62 05 00 B5 62 05 00 41 F7 00 00 00 24 03 00 29
