...
test("file-to-bytecode.js works", async () => {
  ...
  expect(bytecodeView).toMatchInlineSnapshot(`
    "Buffer [
    	...
    	│0x000001C0│ 00 61 01 00 61 00 00 06 11 F2 EB 1A 7E 81 00 0E
    	│0x000001D0│ C9 81 00 0E CA 81 00 0E CB 81 00 0E CC 81 00 0E
    	│0x000001E0│ C3 04 84 EC 09 0E 38 F0 00 00 00 EC E0 62 02 00
