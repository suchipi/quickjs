...
test("file-to-bytecode.js works", async () => {
  ...
  expect(bytecodeView).toMatchInlineSnapshot(`
    "Buffer [
    	...
    	│0x00000160│ 03 01 0D BC 03 00 01 08 EB 05 C1 00 E4 29 E0 EF
    	...
    	│0x000001C0│ 00 61 02 00 61 01 00 61 00 00 06 11 F3 EC 1A 7F
    	│0x000001D0│ 82 00 0E CA 82 00 0E CB 82 00 0E CC 82 00 0E CD
    	│0x000001E0│ 82 00 0E C4 04 85 ED 09 0E 38 E6 00 00 00 ED E0
    	│0x000001F0│ 62 02 00 11 EB 05 0E 62 03 00 97 EB 10 38 94 00
    	│0x00000200│ 00 00 11 04 E7 00 00 00 21 01 00 2F 62 04 00 97
    	│0x00000210│ EB 09 62 02 00 11 63 04 00 0E 66 00 00 42 E8 00
    	│0x00000220│ 00 00 62 02 00 0B 62 04 00 4C E3 00 00 00 24 02
    	│0x00000230│ 00 C4 05 66 01 00 42 E9 00 00 00 62 03 00 04 EA
    	│0x00000240│ 00 00 00 24 02 00 C4 06 62 06 00 42 EB 00 00 00
    	│0x00000250│ 62 05 00 B6 62 05 00 41 EC 00 00 00 24 03 00 29
