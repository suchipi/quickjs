...
test("file-to-bytecode.js works", async () => {
  ...
  expect(bytecodeView).toMatchInlineSnapshot(`
    "Buffer [
    	...
    	│0x00000130│ 79 74 65 4C 65 6E 67 74 68 0D B2 03 02 B4 03 B6
    	│0x00000140│ 03 00 00 02 00 FC 01 00 01 FC 01 01 00 0C 20 06
    	│0x00000150│ 01 A2 01 00 00 00 01 03 01 0C 00 B8 03 00 0D BA
    	│0x00000160│ 03 01 0D BC 03 00 01 08 EC 05 C2 00 E5 29 E1 F0
    	│0x00000170│ 0E 06 2E B2 03 01 04 01 00 07 3E 0C 43 06 01 BC
    	│0x00000180│ 03 00 07 00 05 02 00 AB 01 07 BE 03 01 00 20 C0
    	│0x00000190│ 03 01 01 20 C2 03 01 02 20 C4 03 01 03 20 C6 03
    	│0x000001A0│ 01 04 20 C8 03 01 05 30 CA 03 01 06 30 BA 03 01
    	│0x000001B0│ 0C B8 03 00 0C 61 06 00 61 05 00 61 04 00 61 03
    	│0x000001C0│ 00 61 02 00 61 01 00 61 00 00 06 11 F4 ED 1A 7F
    	│0x000001D0│ 82 00 0E CB 82 00 0E CC 82 00 0E CD 82 00 0E CE
    	│0x000001E0│ 82 00 0E C5 04 86 EE 09 0E 38 E6 00 00 00 EE E0
    	│0x000001F0│ 62 02 00 11 EC 05 0E 62 03 00 98 EC 10 38 94 00
    	│0x00000200│ 00 00 11 04 E7 00 00 00 21 01 00 2F 62 04 00 98
    	│0x00000210│ EC 09 62 02 00 11 63 04 00 0E 66 00 00 42 E8 00
    	│0x00000220│ 00 00 62 02 00 0B 62 04 00 4C E3 00 00 00 24 02
    	│0x00000230│ 00 C5 05 66 01 00 42 E9 00 00 00 62 03 00 04 EA
    	│0x00000240│ 00 00 00 24 02 00 C5 06 62 06 00 42 EB 00 00 00
    	│0x00000250│ 62 05 00 B7 62 05 00 41 EC 00 00 00 24 03 00 29
    	│0x00000260│ B2 03 0C 0C 6C 9E 27 44 3B 12 09 21 2D 80 6C 76
    ]"
  `);
});
