...
test("bytecode - normal values", async () => {
  ...
  expect(run.cleanResult()).toMatchInlineSnapshot(`
    ...
    fromValue { a: 5 } ArrayBuffer {
    	│0x00000000│ 04 01 02 61 08 01 B2 03 05 0A
    }
    back toValue {
    	a: 5
    }
  ...
  expect(run.cleanResult()).toMatchInlineSnapshot(`
    {
      ...
      "stdout": "fromFile ArrayBuffer {
    	...
    	│0x00000030│ 01 00 04 00 00 12 01 A4 01 00 00 00 38 D9 00 00
    	│0x00000040│ 00 42 DA 00 00 00 B9 B9 9F 24 01 00 CF 28 B6 03
    	│0x00000050│ 01 00
    }
  ...
  expect(run.cleanResult()).toMatchInlineSnapshot(`
    {
      ...
      "stdout": "fromFile ArrayBuffer {
    	...
    	│0x00000030│ 6F 67 16 65 78 70 6F 72 74 69 6E 67 20 35 0D B2
    	│0x00000040│ 03 00 01 00 00 B4 03 00 00 00 0C 20 06 01 A2 01
    	│0x00000050│ 00 00 00 03 01 00 1B 00 B4 03 00 0D 08 EC 02 29
    	│0x00000060│ 38 DB 00 00 00 42 DC 00 00 00 04 DD 00 00 00 24
    	│0x00000070│ 01 00 0E BC E3 06 2E B2 03 01 03 01 17 62
    }
    toValue Function "bound bytecode" {
    	│1│ function bound bytecode() {
    	│2│     [native code]
