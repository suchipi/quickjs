  ...
  expect(run.cleanResult()).toMatchInlineSnapshot(`
    {
      ...
      "stdout": "fromFile ArrayBuffer {
    	...
    	│0x00000040│ 00 42 E5 00 00 00 B8 B8 9D 24 01 00 CE 28 CC 03
    	│0x00000050│ 01 00
    }
  ...
  expect(run.cleanResult()).toMatchInlineSnapshot(`
    {
      ...
      "stdout": "fromFile ArrayBuffer {
    	...
    	│0x00000050│ 00 00 00 03 01 00 1B 00 CA 03 00 0D 08 EB 02 29
    	│0x00000060│ 38 E6 00 00 00 42 E7 00 00 00 04 E8 00 00 00 24
    	│0x00000070│ 01 00 0E BB E2 06 2E C8 03 01 03 01 17 62
    }
    toValue Function "bound bytecode" {
    	│1│ function bound bytecode() {
    	│2│     [native code]
