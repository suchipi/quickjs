  ...
  expect(run.cleanResult()).toMatchInlineSnapshot(`
    {
      ...
      "stdout": "fromFile ArrayBuffer {
    	...
    	│0x00000040│ 00 43 DD 00 00 00 B9 B9 9F 24 01 00 CF 28 BC 03
  ...
  expect(run.cleanResult()).toMatchInlineSnapshot(`
    {
      ...
      "stdout": "fromFile ArrayBuffer {
    	...
    	│0x00000050│ 00 00 00 03 01 00 1B 00 BA 03 00 0D 08 EC 02 29
    	│0x00000060│ 39 DE 00 00 00 43 DF 00 00 00 04 E0 00 00 00 24
    	│0x00000070│ 01 00 0E BC E3 06 2F B8 03 06 00 00 2F 0E 34 08
    	│0x00000080│ 00
    }
    toValue Function "bound bytecode" {
    	│1│ function bound bytecode() {
