...
test("bytecode", async () => {
  ...
  expect(run.result).toMatchInlineSnapshot(`
    ...
    fromValue { a: 5 } ArrayBuffer {
    	│0x00000000│ 02 01 02 61 08 01 C4 03 05 0A
    }
    back toValue {
    	a: 5
    }
    fromFile ArrayBuffer {
    	...
    	│0x00000030│ 01 00 04 00 00 12 01 A2 01 00 00 00 38 E2 00 00
    	│0x00000040│ 00 42 E3 00 00 00 B7 B7 9D 24 01 00 CD 28 C8 03
    	│0x00000050│ 01 00
    }
