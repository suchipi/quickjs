...
test("bytecode - normal values", async () => {
  ...
  expect(run.cleanResult()).toMatchInlineSnapshot(`
    ...
    fromValue { a: 5 } ArrayBuffer {
    	│0x00000000│ 04 01 02 61 08 01 C0 03 05 0A
    }
    back toValue {
    	a: 5
    }
  ...
  expect(run.cleanResult()).toMatchInlineSnapshot(`
    {
      ...
      "stdout": "fromFile ArrayBuffer {
    	...
    	│0x00000030│ 01 00 04 00 00 12 01 A6 01 00 00 00 39 E0 00 00
    	│0x00000040│ 00 43 E1 00 00 00 B9 B9 9F 24 01 00 CF 28 C4 03
  ...
  expect(run.cleanResult()).toMatchInlineSnapshot(`
    {
      ...
      "stdout": "fromFile ArrayBuffer {
    	...
    	│0x00000030│ 6F 67 16 65 78 70 6F 72 74 69 6E 67 20 35 0D C0
    	│0x00000040│ 03 00 01 00 00 C2 03 00 00 00 0C 20 06 01 A4 01
    	│0x00000050│ 00 00 00 03 01 00 1B 00 C2 03 00 0D 08 EC 02 29
    	│0x00000060│ 39 E2 00 00 00 43 E3 00 00 00 04 E4 00 00 00 24
    	│0x00000070│ 01 00 0E BC E3 06 2F C0 03 06 00 00 2F 0E 34 08
    	│0x00000080│ 00
    }
    toValue Function "bound bytecode" {
    	│1│ function bound bytecode() {
