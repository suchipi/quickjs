...
test("bytecode - normal values", async () => {
  ...
  expect(run.cleanResult()).toMatchInlineSnapshot(`
    ...
    fromValue { a: 5 } ArrayBuffer {
    	│0x00000000│ 06 01 02 61 08 01 DC 03 05 0A
    }
    back toValue {
    	a: 5
    }
  ...
  expect(run.cleanResult()).toMatchInlineSnapshot(`
    {
      ...
      "stdout": "fromFile ArrayBuffer {
    	...
    	│0x00000030│ 01 00 04 00 01 00 10 01 AA 01 00 00 00 DC 03 00
    	│0x00000040│ 05 00 38 00 00 3E EF 00 00 00 B4 B4 9A 24 01 00
    	│0x00000050│ CA 28 E0 03 08 00 00 11 0E 25 0E 07 05 00
    }
  ...
  expect(run.cleanResult()).toMatchInlineSnapshot(`
    {
      ...
      "stdout": "fromFile ArrayBuffer {
    	...
    	│0x00000030│ 6F 67 16 65 78 70 6F 72 74 69 6E 67 20 35 0D DC
    	│0x00000040│ 03 00 01 00 00 DE 03 00 00 00 0C 20 06 01 A8 01
    	│0x00000050│ 00 00 00 03 00 02 00 19 00 DE 03 00 1E 00 E0 03
    	│0x00000060│ 00 05 00 08 E7 02 29 38 01 00 3E F1 00 00 00 04
    	│0x00000070│ F2 00 00 00 24 01 00 0E B7 DE 06 2F DC 03 06 00
