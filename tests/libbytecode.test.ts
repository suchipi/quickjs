  ...
  expect(run.cleanResult()).toMatchInlineSnapshot(`
    {
      ...
      "stdout": "fromFile ArrayBuffer {
    	...
    	│0x00000030│ 01 00 04 00 00 12 01 AA 01 00 00 00 39 EC 00 00
    	│0x00000040│ 00 43 ED 00 00 00 B9 B9 9F 24 01 00 CF 28 DC 03
  ...
  expect(run.cleanResult()).toMatchInlineSnapshot(`
    {
      ...
      "stdout": "fromFile ArrayBuffer {
    	...
    	│0x00000050│ 00 00 00 03 01 00 1B 00 DA 03 00 0D 08 EC 02 29
    	│0x00000060│ 39 EE 00 00 00 43 EF 00 00 00 04 F0 00 00 00 24
    	│0x00000070│ 01 00 0E BC E3 06 2F D8 03 06 00 00 2F 0E 34 08
    	│0x00000080│ 00
    }
    toValue Function "bound bytecode" {
    	│1│ function bound bytecode() {
