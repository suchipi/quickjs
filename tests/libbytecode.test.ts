...
test("bytecode - normal values", async () => {
  ...
  expect(run.cleanResult()).toMatchInlineSnapshot(`
    ...
    fromValue { a: 5 } ArrayBuffer {
    	│0x00000000│ 03 01 02 61 08 01 C6 03 05 0A
    }
    back toValue {
    	a: 5
    }
  ...
  expect(run.cleanResult()).toMatchInlineSnapshot(`
    {
      ...
      "stdout": "fromFile ArrayBuffer {
    	...
    	│0x00000040│ 03 00 01 00 00 C8 03 00 00 00 0E 20 06 01 A2 01
    	│0x00000050│ 00 00 00 03 01 00 1B 00 C8 03 00 0D 08 EA 02 29
    	│0x00000060│ 38 E5 00 00 00 42 E6 00 00 00 04 E7 00 00 00 24
    	│0x00000070│ 01 00 0E BA E1 06 2E C6 03 01 03 01 17 62
    }
    toValue Function "bound bytecode" {
    	│1│ function bound bytecode() {
    	│2│     [native code]
