...
test("bytecode - normal values", async () => {
  ...
  expect(run.cleanResult()).toMatchInlineSnapshot(`
    ...
    fromValue { a: 5 } ArrayBuffer {
    	│0x00000000│ 06 01 02 61 08 01 DE 03 05 0A
    }
    back toValue {
    	a: 5
    }
  ...
  expect(run.cleanResult()).toMatchInlineSnapshot(`
    {
      ...
      "stdout": "fromFile ArrayBuffer {
    	...
    	│0x00000030│ 01 00 04 00 01 00 10 01 AA 01 00 00 00 DE 03 00
    	│0x00000040│ 05 00 38 00 00 3E F0 00 00 00 B5 B5 9B 24 01 00
    	│0x00000050│ CB 28 E2 03 08 00 00 11 0E 25 0E 07 05 00
    }
  ...
  expect(run.cleanResult()).toMatchInlineSnapshot(`
    {
      ...
      "stdout": "fromFile ArrayBuffer {
    	...
    	│0x00000030│ 6F 67 16 65 78 70 6F 72 74 69 6E 67 20 35 0D DE
    	│0x00000040│ 03 00 01 00 00 E0 03 00 00 00 0C 20 06 01 A8 01
    	│0x00000050│ 00 00 00 03 00 02 00 19 00 E0 03 00 1E 00 E2 03
    	│0x00000060│ 00 05 00 08 E8 02 29 38 01 00 3E F2 00 00 00 04
    	│0x00000070│ F3 00 00 00 24 01 00 0E B8 DF 06 2F DE 03 06 00
    	│0x00000080│ 00 25 0E 34 08 00
    }
    toValue Function "bound bytecode" {
    	│1│ function bound bytecode() {
    	│2│     [native code]
  ...
  expect(run.cleanResult()).toMatchInlineSnapshot(`
    {
      ...
      "error": null,
      "stderr": "",
      "stdout": "default bytes: 210
    strip source bytes: 166
