...
test("bytecode - normal values", async () => {
  ...
  expect(run.cleanResult()).toMatchInlineSnapshot(`
    ...
    fromValue { a: 5 } ArrayBuffer {
    	│0x00000000│ 06 01 02 61 08 01 D6 03 05 0A
    }
    back toValue {
    	a: 5
    }
  ...
  expect(run.cleanResult()).toMatchInlineSnapshot(`
    {
      ...
      "stdout": "fromFile ArrayBuffer {
    	...
    	│0x00000030│ 01 00 04 00 00 12 01 AA 01 00 00 00 39 EB 00 00
    	│0x00000040│ 00 43 EC 00 00 00 B9 B9 9F 24 01 00 CF 28 DA 03
  ...
  expect(run.cleanResult()).toMatchInlineSnapshot(`
    {
      ...
      "stdout": "fromFile ArrayBuffer {
    	...
    	│0x00000030│ 6F 67 16 65 78 70 6F 72 74 69 6E 67 20 35 0D D6
    	│0x00000040│ 03 00 01 00 00 D8 03 00 00 00 0C 20 06 01 A8 01
    	│0x00000050│ 00 00 00 03 01 00 1B 00 D8 03 00 0D 08 EC 02 29
    	│0x00000060│ 39 ED 00 00 00 43 EE 00 00 00 04 EF 00 00 00 24
    	│0x00000070│ 01 00 0E BC E3 06 2F D6 03 06 00 00 2F 0E 34 08
    	│0x00000080│ 00
    }
    toValue Function "bound bytecode" {
    	│1│ function bound bytecode() {
