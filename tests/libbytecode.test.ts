...
test("bytecode - normal values", async () => {
  ...
  expect(run.cleanResult()).toMatchInlineSnapshot(`
    ...
    fromValue { a: 5 } ArrayBuffer {
    	│0x00000000│ 06 01 02 61 08 01 D8 03 05 0A
    }
    back toValue {
    	a: 5
    }
  ...
  expect(run.cleanResult()).toMatchInlineSnapshot(`
    {
      ...
      "stdout": "fromFile ArrayBuffer {
    	...
    	│0x00000030│ 01 00 04 00 00 12 01 AA 01 00 00 00 38 EC 00 00
    	│0x00000040│ 00 41 ED 00 00 00 B7 B7 9D 24 01 00 CD 28 DC 03
  ...
  expect(run.cleanResult()).toMatchInlineSnapshot(`
    {
      ...
      "stdout": "fromFile ArrayBuffer {
    	...
    	│0x00000030│ 6F 67 16 65 78 70 6F 72 74 69 6E 67 20 35 0D D8
    	│0x00000040│ 03 00 01 00 00 DA 03 00 00 00 0C 20 06 01 A8 01
    	│0x00000050│ 00 00 00 03 01 00 1B 00 DA 03 00 0D 08 EA 02 29
    	│0x00000060│ 38 EE 00 00 00 41 EF 00 00 00 04 F0 00 00 00 24
    	│0x00000070│ 01 00 0E BA E1 06 2F D8 03 06 00 00 2F 0E 34 08
    	│0x00000080│ 00
    }
    toValue Function "bound bytecode" {
    	│1│ function bound bytecode() {
