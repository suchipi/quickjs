...
test("bytecode - normal values", async () => {
  ...
  expect(run.cleanResult()).toMatchInlineSnapshot(`
    ...
    fromValue { a: 5 } ArrayBuffer {
    	│0x00000000│ 06 01 02 61 08 01 DA 03 05 0A
    }
    back toValue {
    	a: 5
    }
  ...
  expect(run.cleanResult()).toMatchInlineSnapshot(`
    {
      ...
      "stdout": "fromFile ArrayBuffer {
    	...
    	│0x00000030│ 01 00 04 00 01 00 10 01 AA 01 00 00 00 DA 03 00
    	│0x00000040│ 05 00 38 00 00 3E EE 00 00 00 B4 B4 9A 24 01 00
    	│0x00000050│ CA 28 DE 03 08 00 00 11 0E 25 0E 07 05 00
    }
  ...
  expect(run.cleanResult()).toMatchInlineSnapshot(`
    {
      ...
      "stdout": "fromFile ArrayBuffer {
    	...
    	│0x00000050│ 00 00 00 03 00 02 00 19 00 DC 03 00 1E 00 DE 03
    	│0x00000060│ 00 05 00 08 E7 02 29 38 01 00 3E F0 00 00 00 04
    	│0x00000070│ F1 00 00 00 24 01 00 0E B7 DE 06 2F DA 03 06 00
