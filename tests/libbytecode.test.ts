...
test("bytecode - normal values", async () => {
  ...
  expect(run.cleanResult()).toMatchInlineSnapshot(`
    ...
    fromValue { a: 5 } ArrayBuffer {
    	│0x00000000│ 06 01 02 61 08 01 E6 03 05 0A
    }
    back toValue {
    	a: 5
    }
  ...
  expect(run.cleanResult()).toMatchInlineSnapshot(`
    {
      ...
      "stdout": "fromFile ArrayBuffer {
    	...
    	│0x00000040│ 05 00 38 00 00 3E F4 00 00 00 B5 B5 9B 24 01 00
    	│0x00000050│ CB 28 EA 03 08 00 00 11 0E 25 0E 07 05 00
    }
  ...
  expect(run.cleanResult()).toMatchInlineSnapshot(`
    {
      ...
      "stdout": "fromFile ArrayBuffer {
    	...
    	│0x00000060│ 00 05 00 08 E8 02 29 38 01 00 3E F6 00 00 00 04
    	│0x00000070│ F7 00 00 00 24 01 00 0E B8 DF 06 2F E6 03 06 00
