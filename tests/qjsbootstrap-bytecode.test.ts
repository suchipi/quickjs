...
// Generated by running this in qjs: require("bytecode").fromFile("blah.js")
const bytecode = Buffer.from([
  2, 3, 14, 99, 111, 110, 115, 111, 108, 101, 6, 108, 111, 103, 14, 98, 108, 97,
  104, 46, 106, 115, 14, 0, 6, 0, 160, 1, 0, 1, 0, 4, 0, 0, 18, 1, 162, 1, 0, 0,
  0, 56, 225, 0, 0, 0, 66, 226, 0, 0, 0, 183, 183, 157, 36, 1, 0, 205, 40, 198,
  3, 1, 0,
]);
