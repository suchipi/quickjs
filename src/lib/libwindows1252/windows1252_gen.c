/*
 * Windows-1252 table generator
 *
 * Reads the WHATWG index-windows-1252.txt file and generates a C header
 * containing:
 *   1. The decode table (pointer → Unicode)
 *   2. The encode table (Unicode → byte) for encoding
 *
 * Usage: windows1252_gen <input_dir> <output_file>
 *
 * The input_dir should contain index-windows-1252.txt
 */
...
int main(int argc, char **argv)
{
    ...
    snprintf(inpath, sizeof(inpath), "%s/index-windows-1252.txt", argv[1]);
    ...
    fprintf(stderr, "windows1252_gen: read %d entries\n", encode_count);
    ...
    fprintf(fout, "/* Auto-generated by windows1252_gen from index-windows-1252.txt. Do not edit. */\n\n");

    /* Decode table */
    fprintf(fout, "#define WINDOWS1252_TABLE_SIZE %d\n\n", TABLE_SIZE);
    fprintf(fout, "static const unsigned int windows1252_decode_table[WINDOWS1252_TABLE_SIZE] = {\n");
    ...
    fprintf(fout, "#define WINDOWS1252_ENCODE_SIZE %d\n\n", encode_count);
    fprintf(fout, "typedef struct {\n");
    fprintf(fout, "    unsigned int codepoint;\n");
    fprintf(fout, "    unsigned char byte;\n");
    fprintf(fout, "} Windows1252EncodeEntry;\n\n");
    fprintf(fout, "static const Windows1252EncodeEntry windows1252_encode_table[WINDOWS1252_ENCODE_SIZE] = {\n");
