const deps_host = [
  ...
  builddir("intermediate/dtoa.host.o"),
  ...
  builddir("intermediate/gettime.host.o"),
...
const deps_target = [
  ...
  builddir("intermediate/dtoa.target.o"),
  ...
  builddir("intermediate/gettime.target.o"),
  builddir("intermediate/utf-conv.target.o"),
