...
(x86_64-w64-mingw32-gcc -c inspect.c  -g -flto -o inspect.target.o -D_GNU_SOURCE -D__USE_MINGW_ANSI_STDIO -D_WIN32 -DCONFIG_VERSION="\"suchipi-`git rev-parse --short HEAD`\"" -DCONFIG_BIGNUM -DCONFIG_LTO -DCONFIG_PREFIX="\"/usr/local\"" -DCONFIG_ALL_UNICODE -static -Wall -lpthread -lm)
cd "../run-test262"
...
(x86_64-w64-mingw32-gcc-ar -rcs quickjs.target.a ../cutils/cutils.target.o ../libbf/libbf.target.o ../libregexp/libregexp.target.o ../libunicode/libunicode.target.o ../quickjs/quickjs.target.o ../quickjs-libc/quickjs-libc.target.o ../inspect/inspect.target.o)
